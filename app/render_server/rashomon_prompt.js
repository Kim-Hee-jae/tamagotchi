...
export const RASHOMON_FALLBACKS = {
  ...
  rupture:
    "분명 당신은 반대쪽을 짚어 주셨습니다. 그래서 재판에서는 그 사람이 범인으로 잡혀갔고, 저는 그 결말이 당연하다고 믿고 있습니다.",
  ending:
...
export function buildRashomonSystemPrompt({
  ...
  const phaseRules = isRupture
    ? [
        ...
        "이전 normal phase의 memorySummary, userTheory, userBeliefs, userSuspicions를 보고 사용자가 의심하거나 믿었던 대상을 추정한다.",
        "재판 결과로 나무꾼은 사용자가 말한 내용과 반대되는 대상을 범인으로 지목했다.",
        "그 결과 그 반대 대상이 범인으로 잡혀갔다는 결말이 이미 남아 있다.",
        ...
        "대화의 중심은 왜곡된 기억, 반대로 지목된 범인, 그 범인이 잡혀간 재판 결과다.",
