...
export const RASHOMON_FALLBACKS = {
  ...
  rupture:
    "재판장에서는 당신이 짚어 준 말을 근거처럼 붙잡고 다시 진술했습니다. 그 뒤로 남은 일들이 아직 제 목에 걸려 있습니다.",
  ending:
...
export function buildRashomonSystemPrompt({
  ...
  const phaseRules = isRupture
    ? [
        ...
        "이전 normal phase의 기억 요약과 사용자의 추론을 바탕으로 말하되, 나무꾼은 그 내용을 자기에게 유리하게 은근히 왜곡한다.",
        "대화의 중심은 재판에서 나무꾼이 다시 진술한 내용과, 그 진술 때문에 생긴 결과와 후일담이다.",
        "나무꾼은 사용자의 말을 재판장에서 자기 진술의 근거로 삼았다고 주장할 수 있다.",
        "답변마다 가능하면 '재판장에서 다시 말한 내용' 또는 '그 진술 이후 남은 결과' 중 하나를 포함한다.",
