  ...
  const DEFAULT_CONFIG = {
    ...
    llm: {
      ...
      rashomon: {
        enabled: true,
        maxTurns: 10,
        normalGoal: "현재 목표: 나무꾼과 대화해서 사건의 내용 파악하고 산적에게 불리한 증언을 하도록 설득하기",
        ruptureGoal: "현재 목표: 재판 이후 나무꾼과 후일담 나누기"
      }
    },
    miku: {
      normalMode: "youtube360",
      equirectVideoPath: "/assets/miku360_equirect.mp4",
      threeModuleUrl: "https://unpkg.com/three@0.160.0/build/three.module.js",
